          ...
          <FadeIn>
            <div>
              ...
              <p className="font-body text-gray-600 text-lg leading-relaxed mb-8">
                Founded by Georgetown EMBA alumni with roots across the African continent, we bring firsthand cultural knowledge to every program we design. Our team lives and works in the communities where your students will learn. That is not a selling point. It is our foundation.
              </p>
              ...
              <div className="mb-8">
                ...
                <p className="font-body text-gray-600 leading-relaxed mb-6">
                  Our mission is to shape the African narrative through meaningful educational initiatives. We believe the story of this continent should be told by the people who know it best, and experienced by those willing to listen.
                </p>
                
                <ul className="space-y-3">
                  {['Community-Led Cultural Programming', 'Project-Based Industry Placements', 'Cross-Continental Professional Networks'].map((item, index) => (
                    <motion.li 
                      key={item} 
                      ...
                      viewport={{ once: true }}
                      transition={{ delay: index * 0.15, duration: 0.3, ease: [0.25, 0.1, 0.25, 1] }}
                    >
            ...
            <div className="relative">
              <div className="aspect-video bg-gray-200 rounded-lg overflow-hidden relative">
                <img
                  ...
                  alt="Students from leading U.S. universities experiencing Africa-based study abroad programs with Hilltop Global Group"
