    ...
    <section className="py-20 bg-gray-50">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white p-12 rounded-3xl shadow-2xl text-center">
          <div className="flex flex-col md:flex-row items-center justify-center gap-12">
            ...
            <div className="flex-1 text-left">
              ...
              <button
                className="w-full inline-flex items-center justify-center gap-3 px-8 py-4 font-heading font-bold text-lg text-white rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-xl"
        ...
        <div className="mt-12 bg-white p-8 rounded-2xl shadow-lg">
          <h3 className="font-heading font-bold text-2xl mb-6 text-center" style={{ color: '#1D3160' }}>
