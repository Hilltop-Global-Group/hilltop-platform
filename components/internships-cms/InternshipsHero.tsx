      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center">
          ...
          <p className="text-lg sm:text-xl text-white/90 max-w-5xl mx-auto leading-relaxed">
            Explore our current internship programs across Africa. Gain hands-on experience with leading organizations while immersing yourself in vibrant African cultures.
          </p>
        </div>
      </div>
